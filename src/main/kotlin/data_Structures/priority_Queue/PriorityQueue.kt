 ...
 */
fun PriorityQueue.offer(elem: Patient) {
    heap[size] = elem
 ...
 * Time Complexity: O(log₂n)
 */
private fun PriorityQueue.decreaseKey(index: Int) {
    var i = index
 ...
 */
fun PriorityQueue.peek(): Patient? =
    heap[0]
 ...
 */
fun PriorityQueue.poll(): Patient? {
    val elem = peek()
    if (elem != null) {
        heap[0] = heap[--size]
 ...
 */
fun PriorityQueue.update(newStatus: Patient) {
